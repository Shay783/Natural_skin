...
<body style="background-color:rgb(255, 242, 248);">
  ...
  <div>
    <div class="row">
      ...
      include_once "./panier/con_dbb.php";
      ...
      ?>
        ...
        <div class="text col-sm-6 mb-3 mb-sm-0">
          ...
          <button type="button" class="btn btn-light" style="background-color:#c3d3ff;"><a href="./panier/ajouter_panier.php?id=<?= $row['id'] ?>">Ajouter au panier</a></button>
